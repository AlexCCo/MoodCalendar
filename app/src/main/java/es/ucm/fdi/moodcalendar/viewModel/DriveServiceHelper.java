...
public class DriveServiceHelper {
    ...
    private final String APP_FILE_NAME = "MoodCalendarData";
    //      ************************************************
    ...
    public DriveServiceHelper(Drive driveService, String driveScope, String searchLookUp) {
        mDriveService = driveService;
        APP_FOLDER = driveScope;
        SEARCH_SPACE = searchLookUp;
    }
        ...
        return Tasks.call(mExecutor, new Callable<String>() {
            ...
            public String call() throws Exception {
                File metadata = new File()
                        ...
                        .setMimeType(JSON_MYME)
                        .setName(APP_FILE_NAME);
     ...
     * content}.
     */
    public Task<Void> saveFile(final String fileId,final String content) {
        return Tasks.call(mExecutor, new Callable<Void>() {
            @Override
            public Void call() throws Exception {
                // Create a File containing any metadata changes.
                File metadata = new File().setName(APP_FILE_NAME);
...
//                      Edited By Alejandro Cancelo Correia
        ...
        return Tasks.call(mExecutor, new Callable<String>() {
            ...
            public String call() throws Exception {
                FileList result = mDriveService.files().list()
                        .setQ("name = '" + APP_FILE_NAME + "' and mimeType ='" + JSON_MYME + "'")
                        //for reading in the drive.appdata folder where our application will create the file
                        .setSpaces(SEARCH_SPACE)
                        .execute();
                List<File> files = result.getFiles();
                if (files.size() == 1) {
                    //appData folder should contain only one file
    ...
    public Task<List<File>> listFiles() {
